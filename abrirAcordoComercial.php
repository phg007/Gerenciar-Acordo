...
<head>
    ...
    <title>Abrir Acordo Comercial</title>
    ...
    <link rel="stylesheet" href="css/style_abrirAcordoComercial.css" type="text/css">
    <?php
                        ...
                        <div class="card" style="margin-top: 3rem;">
                            ...
                            <div class="card-body">
                                    ...
                                    <table id="comercialAcordo" class="table table-bordered text-center">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="imprimir"><i class="fas fa-print"></i> </td>
                                                <td class="AbrirModal"><i class="fas fa-external-link-alt"></i></td>
                                ...
                                <div class="col-lg-12 pt-4" style="text-align: right;">
                                    <button type="button" id="aprovarAbrirAcordoComercial" style="background-color: #00a550 ;color: white;font-weight:bold; " class="btn">Aprovar</button>
...
<script src="js/script_abrirAcordoComercial.js"></script>
